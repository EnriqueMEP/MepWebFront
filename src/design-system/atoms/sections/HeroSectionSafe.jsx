...
/**
 * HeroSection - Sección principal de hero (sin video por problemas de carga)
 */
const HeroSection = ({
  badgeText = "Nuevo",
  ...
  const heroStyles = `
    ...
    /* Shape Hero - DELANTE de la imagen (z-index: 2), opacity: 1 */
      ...
      <section className="hero-section">
        <div className="hero-content-wrapper">
          ...
          <div className="hero-image-container">
            {/* Placeholder en lugar de video */}
            <span>Video Area</span>
            
            {/* Shape DELANTE de la imagen con opacity: 1 */}
